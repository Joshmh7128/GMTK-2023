...
public class VillageB_Scenario : Scenario
{
    void Awake()
    {
        ...
        + " Not to be turned away from a challenge our Hero, thinking they have the right tools for the job, pulls out their trusty (Noun) so they can (Verb) these devilish."
